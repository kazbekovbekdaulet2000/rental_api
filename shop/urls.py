...
from shop.views.product_rent_view import ProductRentView, confirm
from shop.views.product_view import ProductBookmarkedList, ProductDetail, ProductFavoriteList, ProductImageList, ProductList, ProductMyList
